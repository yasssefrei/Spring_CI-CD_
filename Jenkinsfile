pipeline {
  ...
  environment {
    ...
    NEXUS_URL   = 'http://54.227.127.253/repository/maven-snapshots/'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://54.227.127.253:8081/repository/maven-snapshots/'
    }
  }
}
  }
