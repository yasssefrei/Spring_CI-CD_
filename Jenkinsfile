pipeline {
  ...
  environment {
    ...
    NEXUS_URL   = 'http://3.94.191.168/repository/maven-snapshots/'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://3.94.191.168:8081/repository/maven-snapshots/'
    }
  }
}
  }
