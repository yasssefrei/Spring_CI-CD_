pipeline {
  ...
  environment {
    ...
    NEXUS_URL   = 'http://3.80.117.109/repository/maven-snapshots/'
  }
...
EOF'''
      ...
      sh 'mvn deploy -B -s settings.xml -DaltDeploymentRepository=nexus::http://3.80.117.109:8081/repository/maven-snapshots/'
    }
  }
}
  }
